...
export default async function SettingsPage() {
  ...
  return (
    <div className="p-5 lg:p-8 max-w-2xl">
      <div className="mb-8">
        <p className="text-xs font-semibold text-zinc-400 uppercase tracking-widest mb-1">Szalon adatok</p>
        <h1 className="text-3xl font-black tracking-tight text-zinc-900">Beállítások</h1>
      </div>
